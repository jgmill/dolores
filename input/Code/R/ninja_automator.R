...
#####
    ...
    ninja_build_wind_url = function(lat, lon, from='2014-01-01', to='2014-12-31', dataset='merra2', capacity=1, height=60, turbine='Vestas+V80+2000', format='csv', metadata = 'false', raw = 'false')
	{
		from = format_date(from)
		to = format_date(to)
		paste0('https://www.renewables.ninja/api/data/wind?&lat=', lat, '&lon=', lon, '&raw=', raw, '&date_from=', from, '&date_to=', to, '&dataset=', dataset, '&capacity=', capacity, '&height=', height, '&turbine=', turbine, '&format=', format, '&metadata=', metadata)
	}
...
#####
	...
	# zero error checking :(
	#
	ninja_get_wind = function(lat, lon, from='2014-01-01', to='2014-12-31', dataset='merra2', capacity=1, height=60, turbine='Vestas+V80+2000',  metadata = 'false', raw = 'false')
	{
